...
/**
 * @version $Id: CoreAdminHandler.java 768165 2009-04-24 06:30:55Z shalin $
 * @since solr 1.3
 */
public class CoreAdminHandler extends RequestHandlerBase {
  ...
  public String getVersion() {
    return "$Revision: 768165 $";
  }

  @Override
  public String getSourceId() {
    return "$Id: CoreAdminHandler.java 768165 2009-04-24 06:30:55Z shalin $";
  }

  @Override
  public String getSource() {
    return "$URL: http://svn.apache.org/repos/asf/lucene/solr/trunk/src/java/org/apache/solr/handler/admin/CoreAdminHandler.java $";
  }
}
