 ...
 * 
 * @version $Id: PluginInfoHandler.java 727944 2008-12-19 06:37:28Z shalin $
 * @since solr 1.2
 */
public class PluginInfoHandler extends RequestHandlerBase
{
  ...
  public String getVersion() {
      return "$Revision: 727944 $";
  }

  @Override
  public String getSourceId() {
    return "$Id: PluginInfoHandler.java 727944 2008-12-19 06:37:28Z shalin $";
  }

  @Override
  public String getSource() {
    return "$URL: http://svn.apache.org/repos/asf/lucene/solr/trunk/src/java/org/apache/solr/handler/admin/PluginInfoHandler.java $";
  }
}
