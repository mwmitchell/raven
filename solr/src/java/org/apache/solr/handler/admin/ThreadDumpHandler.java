 ...
 * 
 * @version $Id: ThreadDumpHandler.java 690025 2008-08-28 22:18:49Z yonik $
 * @since solr 1.2
 */
public class ThreadDumpHandler extends RequestHandlerBase
{
  ...
  public String getSourceId() {
    return "$Id: ThreadDumpHandler.java 690025 2008-08-28 22:18:49Z yonik $";
  }

  @Override
  public String getSource() {
    return "$URL: http://svn.apache.org/repos/asf/lucene/solr/trunk/src/java/org/apache/solr/handler/admin/ThreadDumpHandler.java $";
  }
}
