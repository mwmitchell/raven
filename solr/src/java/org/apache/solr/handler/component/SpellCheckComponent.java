...
public class SpellCheckComponent extends SearchComponent implements SolrCoreAware, SpellingParams {
  ...
  public String getVersion() {
    return "$Revision: 769357 $";
  }

  @Override
  public String getSourceId() {
    return "$Id: SpellCheckComponent.java 769357 2009-04-28 12:16:22Z shalin $";
  }

  @Override
  public String getSource() {
    return "$URL: http://svn.apache.org/repos/asf/lucene/solr/trunk/src/java/org/apache/solr/handler/component/SpellCheckComponent.java $";
  }
