...
final class RequestHandlers {
   ...
   * move
   * 
   * @version $Id: RequestHandlers.java 774766 2009-05-14 13:49:32Z markrmiller $
   * @since solr 1.2
   */
  private static final class LazyRequestHandlerWrapper implements SolrRequestHandler, SolrInfoMBean
  {
    ...
    public String getSourceId() {
      String rev = "$Id: RequestHandlers.java 774766 2009-05-14 13:49:32Z markrmiller $";
      if( _handler != null ) {
    ...
    public String getSource() {
      String rev = "$URL: http://svn.apache.org/repos/asf/lucene/solr/trunk/src/java/org/apache/solr/core/RequestHandlers.java $";
      if( _handler != null ) {
        rev += "\n" + _handler.getSource();
      }
      return rev;
