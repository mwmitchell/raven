...
public class RegexFragmenter extends HighlightingPluginBase implements SolrFragmenter
{
  ...
  public String getVersion() {
      return "$Revision: 557872 $";
  }

  @Override
  public String getSourceId() {
    return "$Id: RegexFragmenter.java 557872 2007-07-20 05:34:23Z klaas $";
  }

  @Override
  public String getSource() {
    return "$URL: http://svn.apache.org/repos/asf/lucene/solr/trunk/src/java/org/apache/solr/highlight/RegexFragmenter.java $";
  }
}
