...
public class HTMLStripReaderTest extends TestCase {
  ...
  public void testStrip() throws Exception {
    String test = "{{aaaaaaaa|aaaaaaaaa|aaa [[aaaaaa aaaaaa]] [[aaaaaaaaa]]|aaaaaaaaa (aaaaaa)}}\n" +
            ...
            "</ttt> aaa aaaa \"aaaaaaaaa\" aaa aaaaaaaaaa aaaa aa a aaaa aa [[aaaaa]], aaa aa aaa [[aaaaaa aaaaaaaaaa]] aaaa aaaaaa aaaa aa aaa ''aaaaa??a'' aaa aaaaaaa aa aaa aaa aaaa aa a aaaaaaaa " +
